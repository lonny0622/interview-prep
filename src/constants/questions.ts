...
export const SEED_QUESTIONS: Question[] = [
  {
    ...
    followUps: [{ question: '什么时候 index 可以作为 key？', answer: '' }, { question: 'key 变化为什么会导致组件重新挂载？', answer: '' }],
  },
  {
    id: 'q-2',
    title: '如何定位前端页面的性能瓶颈？',
    ...
    followUps: [{ question: 'LCP 和 INP 分别反映什么？', answer: '' }, { question: '如何避免优化后引入新的问题？', answer: '' }],
  },
  {
    id: 'q-3',
    ...
    followUps: [{ question: '如果重新做一次，你会改变什么？', answer: '' }],
  },
]
